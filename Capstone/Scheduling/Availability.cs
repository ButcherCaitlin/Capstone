...
namespace Scheduling
{
    public class Availability
    {
        ...
        public bool ScheduleEvent(EventBase toAdd)
        {
            ...
            foreach (EventBase e in possibleConflicts)
            {
                EventBase first,second;
        ...
        public EventBase GetNextEvent(String date, TimeSpan duration)
        {
            //to do
